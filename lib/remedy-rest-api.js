        ...
        if (! that.isAuthenticated){
            ...
            if (missingArgs.length > 0){
                ...
                if (opsError){
                    ...
                    /*
                        insert headers. note 'headers' must be an object
                     */
                     if (that.isNotNull(args.headers) && (args.headers instanceof Object)){ postBody.callback.headers = args.headers; }
            ...
            if (missingArgs.length > 0){
                ...
                if (opsError){
                    ...
                    if (args.hasOwnProperty('endpoint') && that.isNotNull(args.endpoint)){
                        ...
                        // note: if you wanna change headers, you've gotta at least send the endpoint again as well.
                        if (that.isNotNull(args.headers) && (args.headers instanceof Object)){ postBody.callback.headers = args.headers; }
